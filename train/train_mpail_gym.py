...
from gymnasium_mpail import (
    setup_environment,
    get_env_dimensions,
    load_demonstrations,
)
from gymnasium_mpail.gym_configs import create_mpail_runner_cfg, GymLogConfig
...
def main():
    ...
    parser.add_argument("--replay-size", type=int, default=500_0000,
    ...
    runner_cfg = create_mpail_runner_cfg(
        ...
        num_timesteps=args.planning_horizon,
