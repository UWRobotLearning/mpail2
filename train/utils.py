...
def find_demo_file(env_id: str, demo_dir: Optional[str] = None) -> str:
    ...
    search_paths.extend([
        os.path.join(project_root, "train", "gym", "demos", env_id, "*", "expert*.pt"),
        os.path.join(project_root, "train", "gym", "demos", env_id, "*.pt"),
        os.path.join(project_root, "train", "demos", env_id, "*", "expert*.pt"),
        os.path.join(project_root, "train", "demos", env_id, "*.pt"),
        os.path.join(script_dir, "train", "demos", env_id, "*.pt"),
    ])
    ...
    raise FileNotFoundError(
        ...
        f"  {os.path.join(project_root, 'train', 'demos', env_id, '/')}"
    )
